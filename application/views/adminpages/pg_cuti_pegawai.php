			...
			<div class="col-md-12">
				<div class="card">
					...
					<div class="card-content">
						<h4 class="card-title">Cuti Semua Pegawai</h4>
						<div class="toolbar">
							...
							<table id="datacutipegawai" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<select class="ijincuti" data-target="<?=$row['id']?>">
...
var table = $('#datacutipegawai').DataTable({
...
table.on('focus', '.ijincuti', function(e) {
	$.data(this, 'val', $(this).val());
});

table.on('change', '.ijincuti', function(e) {
