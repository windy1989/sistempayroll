			...
			<div class="col-md-12">
				<div class="card">
					...
					<div class="card-content">
						<h4 class="card-title">Lembur Semua Pegawai</h4>
						<div class="toolbar">
							...
							<table id="datalemburpegawai" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
								...
								<tbody>
									...
									<tr>
										...
										<td><?=$row['alasan']?></td>
										<td>
											<select class="ijinlembur" data-target="<?=$row['id']?>">
...
var table = $('#datalemburpegawai').DataTable({
...
table.on('focus', '.ijinlembur', function(e) {
	$.data(this, 'val', $(this).val());
});

table.on('change', '.ijinlembur', function(e) {
	...
	if (!confirm("Yakin ingin mengganti status?")) {
		...
		Pace.track(function () {
			$.ajax({
				method: "POST",
				url: "../admincrud/updateIjinLembur",
