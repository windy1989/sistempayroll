			...
			<div class="col-md-12">
				<div class="card">
					...
					<div class="card-content">
						<h4 class="card-title">Reimburse Semua Pegawai</h4>
						<div class="toolbar">
								...
								<tbody>
									...
									<tr>
										...
										<td class="text-center">
											<select class="ijinreimburse" data-target="<?=$row['id']?>">
...
var table = $('#datareimbursepegawai').DataTable({
...
table.on('focus', '.ijinreimburse', function(e) {
	$.data(this, 'val', $(this).val());
});

table.on('change', '.ijinreimburse', function(e) {
	...
	if (!confirm("Yakin ingin mengganti status?")) {
		...
		Pace.track(function () {
			$.ajax({
				method: "POST",
				url: "../admincrud/updateIjinReimburse",
